        ...
        foreach($tickets as $ticket) {
            ...
            <div class="card mb-2" style="width: 250px;" role="button" data-mdb-ripple-init data-mdb-ripple-color="secondary">
                ...
                <div class="card-body<?php echo $color ?>">
                    <h3 class="card-title text-center"><?php echo $language[$ticket[0]]; ?></h3>
                    <h1 class="text-center fw-bold"><?php echo $ticket[1]; ?> zł<br></h1>
                    <h6 class="text-center"><?php if ($ticket[2]) { echo $language[$ticket[0]."Text"]; } ?></h6>
                </div>
            </div>
            <?php
        }
